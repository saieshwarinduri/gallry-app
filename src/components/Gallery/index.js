...
class Gallery extends Component {
  ...
  render() {
    ...
    const filteredImageLIst = imagesList.filter(
      eachList => eachList.id === imgId,
    )

    console.log(filteredImageLIst[0].id)
    console.log(imgId)
    ...
    return (
      <div className="MainContainer">
        <div className="smallContainer">
          <img
            className="image"
            src={filteredImageLIst[0].imageUrl}
            alt={filteredImageLIst[0].imageAltText}
          />
          ...
          <ul className="list_container">
            {imagesList.map(eachList => (
              <ThumbnailItem
                imageDetails={eachList}
                isActive={imgId === eachList.id}
                key={eachList.id}
